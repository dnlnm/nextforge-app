...
const ChartCardSkeleton = ({ height = "h-[430px]" }: { readonly height?: string }) => (
  <div className={`grid content-start gap-3 rounded-lg border bg-card p-6 text-card-foreground ${height}`}>
