...
export const CTA = ({ dictionary, locale }: CTAProps) => (
  <div className="w-full py-20 lg:py-28">
    <div className="container mx-auto">
      <div className="relative flex flex-col items-center gap-8 overflow-hidden rounded-[24px] border bg-card p-8 text-center shadow-panel lg:p-14">
        <div className="absolute inset-0 -z-10" aria-hidden>
          <img src="https://picsum.photos/seed/klio-cta/1600/600" alt="" className="h-full w-full object-cover opacity-[0.06]" />
          <div className="absolute inset-0 bg-[radial-gradient(800px_circle_at_50%_-10%,color-mix(in_oklab,var(--accent-blue)_14%,transparent),transparent_60%)]" />
        </div>
