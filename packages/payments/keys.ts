...
export const keys = () =>
  createEnv({
    ...
    server: {
      ...
      KLIO_STRIPE_MAX_PRICE_ID: z.string().startsWith("price_").optional(),
      ...
      TLAS_STRIPE_MAX_PRICE_ID: z.string().startsWith("price_").optional(),
    },
    runtimeEnv: {
      ...
      KLIO_STRIPE_MAX_PRICE_ID: process.env.KLIO_STRIPE_MAX_PRICE_ID,
      ...
      TLAS_STRIPE_MAX_PRICE_ID: process.env.TLAS_STRIPE_MAX_PRICE_ID,
    },
  });
