...
import { useSize, type SizeVariant } from "@repo/design-system/lib/size-context";
  ...
  ({ label, checked, onToggle, disabled = false, thumbTransition, size, className, ...props }, ref) => {
    ...
    useEffect(() => {
      ...
      if (!hasMounted.current) {
        ...
        animate(motionX, thumbX, thumbTransition ?? spring.moderate.enter);
      }
        ...
        if (dragging.current) {
          ...
          if (shouldBeOn !== checked) {
            ...
            const snapTarget = checked
              ...
              : THUMB_OFFSET;
            animate(motionX, snapTarget, thumbTransition ?? spring.moderate.enter);
          }
            ...
            render={(props) => {
              ...
              return (
                <motion.span
                  ...
                  transition={hasMounted.current ? (thumbTransition ?? spring.moderate.enter) : { duration: 0 }}
                />
              );
            }}
          />
