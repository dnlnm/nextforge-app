...
import { spring, exitFallbackMs } from "@repo/design-system/lib/springs";
import { useSurface, SurfaceProvider } from "@repo/design-system/lib/surface-context";
...
} from "@repo/design-system/components/ui/fluid-sidebar-core";
          ...
          render={(backdropProps) => {
            ...
            return (
              <motion.div
                ...
                transition={visible ? { duration: spring.moderate.enter.duration } : spring.moderate.exit}
              />
            );
          }}
        />
          ...
          render={(popupProps) => {
            ...
            return (
              <motion.div
                ...
                transition={reduceMotion ? { duration: 0 } : visible ? spring.moderate.enter : spring.moderate.exit}
                onAnimationComplete={() => {
...
} from "@repo/design-system/components/ui/fluid-sidebar-menu";
export type {
  SidebarMenuProps,
