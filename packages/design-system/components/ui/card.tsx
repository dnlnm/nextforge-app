...
export function CardFrameHeader({
  ...
  const defaultProps = {
    className: cn(
      "relative flex min-h-15 grid auto-rows-min grid-rows-[auto_auto] flex-col items-start gap-x-4 px-6 py-4 has-data-[slot=card-frame-action]:grid-cols-[1fr_auto]",
      className,
    ),
