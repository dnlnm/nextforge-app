...
import type { ItemRect } from "@repo/design-system/hooks/use-proximity-hover";
...
const convergeMs = (mergeSpring.enter.duration + cornerDelay) * 1000 + 80;
const splitMs = mergeSpring.enter.duration * 1000 + 80;
    ...
    <AnimatePresence>
      {blocks.map((b) => {
        const corner = b.delayCorners
          ? { ...mergeSpring.enter, delay: b.cornerDelay ?? cornerDelay }
          : mergeSpring.enter;
